					...
					<div class="w-lg-550px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_new_password_form">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Configurar Nova Senha</h1>
								<!--end::Title-->
								<!--begin::Link-->
								<div class="text-gray-400 fw-bold fs-4">Já configurou uma senha nova?
								<a href="../../demo3/dist/authentication/layouts/basic/sign-in.html" class="link-primary fw-bolder">Entre aqui</a></div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<!--end::Wrapper-->
								<!--begin::Hint-->
								<div class="text-muted">Use 8 ou mais caracteres com um mix de letras e múmeros.</div>
								<!--end::Hint-->
							</div>
							<!--end::Input group=-->
							<!--begin::Input group=-->
							<div class="fv-row mb-10">
								<label class="form-label fw-bolder text-dark fs-6">Confirmar a Senha</label>
							...
							<div class="fv-row mb-10">
								<div class="form-check form-check-custom form-check-solid form-check-inline">
									...
									<a href="#" class="ms-1 link-primary">os termos e condições.</a>.</label>
								</div>
							</div>
							<!--end::Input group=-->
							<!--begin::Action-->
